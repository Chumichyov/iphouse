        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('preRegistration') }}">
                            @csrf
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary background-blue">
                                        Создать
                                    </button>

                                    <a class="btn btn-link text-decoration-none text-blue" href="{{ route('login') }}">
                                        Войти
                                    </a>
                                </div>
                            </div>
